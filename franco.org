...
- <<<bidi>>> :: bidirectional text, i.e. mixed English-Arabic text
- <<<CvC>>> :: consonant + short vowel + consonant

* character transliterations
this is not a transliteration system, but for your convenience we compare the symbols of Franco to those of TAWS which you are used to - instead of IPA for example.
...
*** capital consonants 
following consonants are assigned Capital letter transliterations.
...
- SAb and sAb
- mafrOD and mafrOd
- "enSef el-masakEn" and "ensef el-masakEn"
- Dall and dall
- DAr  and dAr
- ba3D and ba3d
- TAr and tAr
...
** COMMENT which one to velarize
    in moBARak both moBArak and mobARak will give the same output
    and in bAT for example we pronounce it like BAT also
    what do you think if we go with both.
...
for programmers, this Emacs-style regular expression will match all possible forms a definite article can take in compliant franco: "e?\(?:l\|\([tT$6dDrzZnsS4kg]\)\)-\1?".
...
** COMMENT whats'up with "ma"
** post-positions
  | traditional | Franco | example       |
  |-------------+--------+---------------|
  | دي          | de     | el-btA3a de   |
  | ده          | da     | el-btA3 da    |
  | دول         | doal   | el-btO3 doal  |
...
another case where the vowel is deleted, is when the preceding word ends with two consecutive consonants like "4oft", "", "esta7melt".. etc, for example:
 ...
 you may have noticed that this case is reducible to the first case, since we can't pronounce three consecutive consonants (the two from the end of the word and the first of the following) we add a very short vowel at the end of the first word to make it pronounceable, so it becomes "4ofte ktEr" which is exactly the first case.
...
* shadda at the end of a word ("maybe" Egyptian specific)
...
w ka2enn asAsn fed-dayra
hena.. howwa hnAk
fa TabE3y t7es enk 3Aye4..
b etnein gowwak
------
akEd e4-4am3a lw kAnet.. 
la2et forSa..
w 7al morE7..
y3ayye4ha.. bedOn matsE7..
w ye7faZ 4aklaha el-sAbet..
kanet 3A4t !!
-------------

* corner cases and current limitations (Egyptian specific)
