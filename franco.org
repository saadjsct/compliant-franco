...
* prepositions
prepositions in compliant franco are attached to following word using backtick (`), pressed with the key on the top left of your keyboard that has a tilda (~) on it.
