...
you may ask what's the problem with writing it without the shadda like "7or" or "bas", since there is no ambiguity the shadda resolves and by definition there can't shadda that consists of two consonants(the second one must have vowel after it). for two reasons:
