...
3) this reason contains circular dependency, you can read it after reading [[*shortening][shortening]].consider this sentence without the shadda at the end "haylef ylef w yerga3ly", if you pronounced it in Egyptian Arabic, you will observe two things:
   1) you shorten "yelef" so that it becomes "ylef" and you shorten "we" so that it becomes "w"
