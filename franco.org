...
** something + stop + CvC
some words doesn't have the shape of CvC, but ends with it, for example "haylef", those words are pronounced like "hay..lef" where the dots represent a brief stop. this is practically equivalent to pronouncing it as two separate words. here also the shadda is added by the same means we added it to "leff".
...
* Assimilation
assimilation is a term for sound changes that occur within a word to ease pronunciation, for example "ganby" becomes "gamby".
...
- "lak" in "ana lak 3ala TOl" as in "lakk" is another word
- "men" in "men hena"
