...
the only Digraph we use is "th" as in "the" not "theatre". we are going with it now because it's rarely used in the Egyptian dialect and seems to be no sane alternative right now. this may be changed in further versions though.
